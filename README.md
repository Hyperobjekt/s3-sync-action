...
Fork of [jakejarvis/s3-sync-action](https://github.com/jakejarvis/s3-sync-action) with an upgraded aws-cli version to fix [this](https://github.com/jakejarvis/s3-sync-action/issues/79).
